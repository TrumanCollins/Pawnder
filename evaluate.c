...
int evaluate(
    ...
    // the better it is for the computer.
    {
        ...
        int            save_curr_level;      // Saves the value in glob__curr_level.
        ...
        if(posit->king_in_check()) {
            ...
            save_curr_level = glob__curr_level;
            glob__curr_level = 0;
            move_top = posit->gen_moves();
            glob__curr_level = save_curr_level;
...
//            }
            ...
            for(ind1 = 1; ind1 < hang_index; ind1++) {
                value += hanging_pieces[ind1].value >> 1;
            }
        }
